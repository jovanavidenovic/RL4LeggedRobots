...
class RexGallopEnv(rex_gym_env.RexGymEnv):
  ...
  """
    ...
    """
        ...
        self._cam_yaw = 0.0
        self._cam_pitch = -20
        self._target_position = None # [JV: gallop as long as you can] target_position
    ...
    def _reward(self):
        ...
        # print(objectives, self._objective_weights)
        reward = sum(weighted_objectives)
        self._objectives.append(objectives)
        # print("Reward", forward_reward, reward)
        return reward
    ...
    def reset(self):
        ...
        self._stay_still = False
        self.is_terminating = False
        self._target_position = None # [JV: gallop as long as you can] 
